...
{
    public class AutoMechanicIdentityContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
    {
        ...
        public AutoMechanicIdentityContext(IOptions<DatabaseOptions> databaseOptions) : base(new DbContextOptions<AutoMechanicIdentityContext>())
        {
